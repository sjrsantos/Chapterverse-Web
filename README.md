# Chapterverse Web App

This project is a continuation of Chapterverse Mobile App.

Despite both of them consuming Open Library API, each one has unique responses and "key-value" pairs.
